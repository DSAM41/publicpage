...
<style><%@include file="/WEB-INF/css/style.css"%></style>
		...
		con.close();
		if(validsession){
					  List<ItemDeparture> list=DataFlight.getDataDepartureHDY();  
...
<body style="margin:0px;overflow:hidden;">    			     
    			     ...
    			     <div style="position: absolute;top: -3px;right: 35px;"><font size="10" color="#fff">HDY</font></div></th></tr></table>
					  <TABLE id="flights">
						    <tr>
						      <th width="8%" style='background-color: #000033 !important;'><font size="6">Time</font></th>
						      <th width="10%" style='background-color: #000033 !important;'><font size="6">Airlines</font></th>
						      <th width="25%" style='background-color: #000033 !important; text-align:left;'><font size="6">To</font></th>
						      ...
						      <th width="25%" style='background-color: #000033 !important;'><font size="6">Remark</font></th>
						    </tr>
						    </TABLE>
    						...
    						{%>		
							     ...
							     <tr <% if(i%2==0) {out.print("class='departurerow2'");}else {out.print("class='departurerow1'");} %>>
							      <td width="8%" align="center"><font size="6" color="#ffffff"><%=list.get(i).getTimeDepart()%></font></td>
							      <td width="10%" align="center"><img style="border-radius: 5px;" src=<%=list.get(i).getAirline()%>></td>
							      <td width="25%"><font size="6" color="#ffffff"><%=list.get(i).getFlightTo()%></font></td>
							      ...
							      <td width="25%" align="center"><font size="6"><%=list.get(i).getStatus()%></font></td>
							    </tr>	 
