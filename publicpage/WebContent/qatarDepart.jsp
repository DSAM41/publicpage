...
<%    
	...
	con.close();
	if(validsession){
		List<ItemQatar> list=DataQatar.getDataDeparture();  
	     ...
	     <table id="flights"><tr><th class="header_th" style='background-color: #681A41 !important;'><font size="6">Departure Flights on <%=departDate%></font></th></tr></table>
		  <TABLE id="flights" style="table-layout:fixed">
			    <tr>
			      ...
			      <th width="10%" class="header-qatar"><font size="5">Airline</font></th>
			      <th width="20%" class="header-qatar"><font size="5">To</font></th>
			      <th width="10%" class="header-qatar"><font size="5">Flight</font></th>
			      <th width="13%" class="header-qatar"><font size="5">Estimated Time</font></th>
			      <th width="10%" class="header-qatar"><font size="5">Gate</font></th>
			      <th width="12%" class="header-qatar"><font size="5">Status</font></th>
			    </tr>
<!-- 			    </TABLE> -->
<!-- 			     <div id="contain" > -->
<!-- 				 <div id="contain-one"> -->
<!-- 				      <table cellpadding="0" cellspacing="0" border="0"> -->
				...
				{%>		
				     ...
				     <tr <% if(i%2==0) {out.print("class='qatarrow2'");} else {out.print("class='qatarrow1'");} %>>
				      <td align="center"><font size="5" color="white"><%=list.get(i).getTimeDepart()%></font></td>
				      <td><img style="border-radius: 5px;" src="image/QR_L.gif" width="10%"></img></td>
				      ...
				      <td><font size="5" color="white"><%=list.get(i).getEstimate()%></font></td>
...
<!-- 					   </div>					 -->
		 <div id="bottom-menu"  style='background-color: #681A41 !important;'>
	      <p>Page Last Update On : <%=newDateUp %> ( Total : 15 )</p>
	     </div>					
			<% 
	}
	else{
