		...
		int airportSize = airportlist.length;
			...
			<div class="box-wrapper">
				...
				<%for(int i = 0; i < airportSize; i++){%>
					<a class="link" href="arrivalFlights<%=airportlist[i] %>.jsp"><%=airportlist[i] %></a>
				<%}%>
<!-- 				<a class="link" href="arrivalFlightsBKK.jsp">BKK</a> <a class="link" href="arrivalFlightsDMK.jsp">DMK</a> -->
<!-- 				<a class="link" href="arrivalFlightsHKT.jsp">HKT</a> <a class="link" href="arrivalFlightsHDY.jsp">HDY</a> -->
<!-- 				<a class="link" href="arrivalFlightsCNX.jsp">CNX</a> <a class="link" href="arrivalFlightsCEI.jsp">CEI</a>	 -->
				</div>
			</div>
			</div>
			<%
