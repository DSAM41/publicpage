...
<style><%@include file="/WEB-INF/css/style.css"%></style>
		...
		con.close();
		if(validsession){
					  List<ItemDeparture> list=DataFlight.getDataDepartureCEI();  
...
function pageScroll() {
	 document.getElementById("contain").scrollTop += 1; // horizontal and vertical scroll increments
	  ...
	  console.log(document.getElementById("contain").scrollTop);
...
<body style="margin:0px;overflow:hidden;">
    			     ...
    			     <div style="position: absolute;top: -3px;right: 50px;"><font size="10" color="#fff">CEI</font></div></th></tr></table>
					  <TABLE id="flights">
						    <tr>
