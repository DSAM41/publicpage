...
<style><%@include file="/WEB-INF/css/style.css"%></style>
		...
		con.close();
		if(validsession){
					  List<ItemDeparture> list=DataFlight.getDataDepartureHKT();  
...
<body style="margin:0px;overflow:hidden;">    			     
    			     ...
    			     <div style="position: absolute;top: -3px;right: 35px;"><font size="10" color="#fff">HKT</font></div></th></tr></table>
					  <TABLE id="flights">
						    <tr>
						      ...
						      <th width="21%" style='background-color: #000033 !important; text-align:left;'><font size="6">To</font></th>
						      <th width="10%" style='background-color: #000033 !important;'><font size="6">Flight</font></th>
						      <th width="7%" style='background-color: #000033 !important;'><font size="6">Departs</font></th>
						      <th width="10%" style='background-color: #000033 !important;'><font size="6">Row</font></th>
						      <th width="5%" style='background-color: #000033 !important;'><font size="6">Gate</font></th>
						      <th width="10%" style='background-color: #000033 !important;'><font size="6">Term</font></th>
						      <th width="17%" style='background-color: #000033 !important;'><font size="6">Remark</font></th>
						    </tr>
						    </TABLE>
    						...
    						{%>		
							     ...
							     <tr <% if(i%2==0) {out.print("class='departurerow2'");}else {out.print("class='departurerow1'");} %>>
							      ...
							      <td width="21%"><font size="6" color="#ffffff"><%=list.get(i).getFlightTo()%></font></td>
							      <td width="10%" align="center"><font size="6" color="#ffffff"><%=list.get(i).getFlight()%></font></td>
							      <td width="7%" align="center"><font size="6" color="#ffffff"><%=list.get(i).getEstimate()%></font></td>
							      <td width="10%"  align="center"><font size="6" color="#ffffff"><%=list.get(i).getRow()%></font></td>
							      <td width="5%"  align="center"><font size="6"><span class="badge badge-warning"><%=list.get(i).getGate()%></span></font></td>
							      <td width="10%"  align="center"><font size="6"><span class="badge badge-success"><%=list.get(i).getTerminal()%></span></font></td>
							      <td width="24%" align="center"><font size="6"><%=list.get(i).getStatus()%></font></td>
							    </tr>	 
							    <% if(list.get(i).getJFNO()!=null && list.get(i).getJFNO().trim().length()>0){ %>
							    <tr <% if(i%2==0) {out.print("class='departurerow2'");}else {out.print("class='departurerow1'");} %>>
							    	<td width="10%" align="center"></td>
							    	<td width="90%" colspan="8" valign="middle"><font size="5"><%=list.get(i).getJFNO()%></font></td>
							    </tr> 
							    <%} %>
    				       	<%}%> 
    				       	</tbody>
